...
func (_mock *MockBotPort) SendDMUpcomingReservationNotification(member1 *member.Member, spotName string, startAt time.Time) error {
...
//   - spotName string
//   - startAt time.Time
func (_e *MockBotPort_Expecter) SendDMUpcomingReservationNotification(member1 interface{}, spotName interface{}, startAt interface{}) *MockBotPort_SendDMUpcomingReservationNotification_Call {
	return &MockBotPort_SendDMUpcomingReservationNotification_Call{Call: _e.mock.On("SendDMUpcomingReservationNotification", member1, spotName, startAt)}
}

func (_c *MockBotPort_SendDMUpcomingReservationNotification_Call) Run(run func(member1 *member.Member, spotName string, startAt time.Time)) *MockBotPort_SendDMUpcomingReservationNotification_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *member.Member
		if args[0] != nil {
			arg0 = args[0].(*member.Member)
...
func (_c *MockBotPort_SendDMUpcomingReservationNotification_Call) RunAndReturn(run func(member1 *member.Member, spotName string, startAt time.Time) error) *MockBotPort_SendDMUpcomingReservationNotification_Call {
	_c.Call.Return(run)
	return _c
}
