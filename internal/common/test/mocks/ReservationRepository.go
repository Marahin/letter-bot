...
func (_c *MockReservationRepository_SelectReservationsForReservationStartsNotification_Call) Return(reservations []*reservation.ReservationWithSpot, err error) *MockReservationRepository_SelectReservationsForReservationStartsNotification_Call {
	_c.Call.Return(reservations, err)
	return _c
}
